...
@register.simple_tag
def upload_js():
    return  gallery_upload_script() + gallery_download_script()

@register.simple_tag
def gallery_upload_script():
    '''
        https://github.com/blueimp/JavaScript-Templates 
      
       - <script id="template-upload" /> jquery.fileupload-ui.js がテンプレートの処理をします 
        o: data オブジェクト
        o.files : file のリスト
    '''
    return """
